...
const ACTIONS = {
  ...
  low: {
    ...
    steps: [
      ...
      'Проверь часовую динамику. Если это разовый час, используй время на перерывы по расписанию, подготовку к пику, чистоту и пополнение.',
      'Помни: перестановка сотрудников не изменит ITPH, потому что их количество на смене останется тем же.',
