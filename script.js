...
function answerChoice(btn, isCorrect, feedbackId) {
  ...
  if (isCorrect) {
    ...
    feedback.innerHTML = '<strong>Пока нет.</strong> Сначала сопоставь ITPH с тем, что происходит на смене: скоростью обслуживания, работой сотрудников на станциях и заготовками. Затем выбери действие по причине.';
...
const ACTIONS = {
  high: {
    ...
    steps: [
      ...
      'При длительной перегрузке попроси сотрудников выйти раньше или в выходной.',
    ],
  },
  low: {
    ...
    steps: [
      ...
      'Убедись, что причина не в медленной работе на станции.',
